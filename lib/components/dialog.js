...
const headerContent = document.querySelector("#modal-header-text");
const headerContainer = document.querySelector("#modal-header");
const content = document.querySelector("#modal-content");
const footer = document.querySelector("#modal-footer");

export function showDeleteAlert(itemId, itemName) {
  //set dialog content
  headerContent.innerHTML = `<i class="fa-solid fa-triangle-exclamation fa-lg"></i>  Please notice before action`;
  ...
  headerContainer.className = "failed";
...
export function showNoticeAlert(message, type) {
  ...
  headerContainer.className = type;
