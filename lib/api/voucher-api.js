...
import { checkDollarStringFormat, formatMoney } from "../utils/currency.js";
import {
  checkIsMobileNumber,
...
export function addEditVoucher(voucher) {
  voucher.originalValueCents = parseInt(voucher.originalValueCents * 100);
  voucher.remainingValueCents = parseInt(voucher.remainingValueCents * 100);
  /*showNoticeAlert(
